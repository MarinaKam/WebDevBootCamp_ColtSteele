...
router.get('/:id/edit', checkOwnerArticle, (req, res) => {
...
router.put('/:id', checkOwnerArticle, (req, res) => {
...
router.delete('/:id', checkOwnerArticle, (req, res) => {
...
function checkOwnerArticle(req, res, next) {
