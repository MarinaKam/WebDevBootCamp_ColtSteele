...
concatenated with the value of the first key and a space and then the value of the last key. See if you can destructure
this object inside of the function.
...
/*
Write a function called printFullName which accepts an object and returns the string "Your full name is" concatenated
with the value of the first key and a space and then the value of the last key. See if you can destructure this object
DIRECTLY from the parameters. The output of the printFullName function should be the exact same as the displayStudentInfo function.
...
/*
Write a function called createStudent which accepts as a parameter, a default parameter which is a destructured object
with the key of likesES2015 and value of true, and key of likesJavaScript and value of true.
...
function createStudent({likesES2015 = true, likesJavaScript = true} = {}){
    return (likesES2015 && likesJavaScript) ? 'The student likes JavaScript and ES2015!' :
        (!likesES2015 && likesJavaScript) ? 'The student likes JavaScript!' :
            (likesES2015 && !likesJavaScript) ? 'The student likes ES2015!' : 'The student does not like much...';
}
