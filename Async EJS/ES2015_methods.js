/*
Write a function called copyObject, which accepts one parameter, an object. The function should return a shallow copy
of the object.
...
console.log(areAllNumbersFinite([4,-3,2.2]));
console.log(areAllNumbersFinite([4,-3,2.2,NaN]));
...
Write a function called displayEvenArguments which accepts a variable number of arguments and returns a new array with
all of the arguments that are even numbers.
